    ...
    try {
        ...
        if ( typeof wd.localStorage !== 'undefined' ) {
            ...
            function ES6Tester() {
                ...
                // for await...of test @suport - In date (July, 27 2020) 90.07% {@link https://caniuse.com/#feat=mdn-javascript_statements_for_await_of}
                eval('async function f() { for await (let x of []) {} }');
                // Spread operator
                eval(';[..."a","b","c"];');
                return true
            };
            ...
            function ExcentialsAPIs() {
                ...
                var nv = wd.navigator,
                     ...
                     * @note    - high consideration to use
                     * @support - in date (May, 07th 2020) 71.53% {@link https://caniuse.com/#feat=mdn-api_storagemanager_persist}
                     *
                    Persist: {
                     ...
                     **
                     * @status  - disabled
                     * @reason  - Firefox bug {@link https://bugzilla.mozilla.org/show_bug.cgi?id=1559743}
                     * @note    - Firefox >= 65 support webp images but, don't support this syncronous detection
                     * @support - in date (May, 07th 2020) 77.63% {@link https://caniuse.com/#feat=webp}
                     *
                    WebP: {
                     ...
                     * @support - in date (May, 07th 2020) 73.89% {@link https://caniuse.com/#feat=broadcastchannel}
                     * @support detailed:
                     *   -- Firefox >= 38   (desktop)
                     ...
                     * @support - in date (May, 07th 2020) 70.94% {@link https://caniuse.com/#feat=mdn-api_eventtarget_eventtarget}
                     */
                    EventTarget: {
